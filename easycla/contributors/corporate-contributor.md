...
1. Click ![](../../.gitbook/assets/lfx-easycla.png) or **Please click here to be authorized**.
2. Click **Authorize LF-Engineering**. \(Subsequent contributions will not require authorization.\)
...
1. Click **Proceed as a Corporate Contributor**.
2. On **Select Organization** window, type your company's name in the field, select it from the drop-down list, and click **Proceed**.
...
2. [If your company is not in the company list](corporate-contributor.md#if-the-select-company-dialog-appears)
3. [If your company has not yet signed a CCLA](corporate-contributor.md#if-company-has-not-signed)
4. [If you have not yet been added to your company's approved list](corporate-contributor.md#if-you-are-not-added-to-the-approved-list)
5. [If you are additionally asked to sign an ICLA](corporate-contributor.md#if-you-are-asked-to-sign-icla)
...
1. Navigate to the Gerrit instance of your project. For example, if you are contributing to the OPNFV project, navigate to [https://gerrit.opnfv.org](https://gerrit.opnfv.org/)​
2. Sign in using your LF [Single Sign-On \(SSO\)](https://docs.linuxfoundation.org/lfx/sso/create-an-account) account.
...
1. Click **Corporate CLA**, and then click the **Please review the agreement** link.

![](../../.gitbook/assets/ccla-flow.png)

1. Click **Proceed To Corporate Authorization**.

![](../../.gitbook/assets/proceed-to-corporate-authorization.png)

1. You are redirected to the Corporate CLA Console. Sign in with your LF SSO account if prompted.
2. You will need to complete one of the following workflows:
3. [If your company is not in the company list](corporate-contributor.md#if-the-select-company-dialog-appears)
4. [If your company has not yet signed a CCLA](corporate-contributor.md#if-company-has-not-signed)
5. [If you have not yet been added to your company's approved list](corporate-contributor.md#if-you-are-not-added-to-the-approved-list)
6. [If you are additionally asked to sign an ICLA](corporate-contributor.md#if-you-are-asked-to-sign-icla)
...
1. Provide organization website URL, and organization name in the respective fields. **Note:** If the website URL is already associated with an organization, the organization name appears in the **Organization Name** field, and you cannot edit the name.
2. Click **Next**.
...
2. **Yes:** Follow the procedure, and click **Proceed** to [coordinate the CCLA signing process](../corporate-cla-managers/coordinate-signing-ccla.md).
3. **No:** Provide name and email address of the person whom you believe should be the CLA Manager from your company for this project, and click **Submit Request**.
...
1. Click an answer: **Are you authorized to be a CLA Manager for your organization?**
2. [Yes](corporate-contributor.md#yes-if-you-are-authorized) — By clicking here, you will become the initial CLA Manager after the CCLA is signed.
3. [No](corporate-contributor.md#no-if-you-are-not-authorized) — By clicking here, you will enter the details for someone else who will become the initial CLA Manager.
...
1. Click **Proceed** again.

![Redirecting to CLA Manager Console](../../.gitbook/assets/redirecting-to-cla-manager-console.png)

1. You will be redirected to the corporate console to [coordinate the CCLA signing process](../corporate-cla-managers/coordinate-signing-ccla.md).
...
1. Click **Request Authorization**. ![](../../.gitbook/assets/request-submitted.png)
