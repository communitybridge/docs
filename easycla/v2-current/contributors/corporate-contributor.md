...
A corporate contributor is one who contributes code on behalf of their employer (and not on their own behalf). If you are contributing code on your own behalf, please see the [Individual Contributor](broken-reference) workflow.
...
* [If your company is not in the company list](broken-reference)
* [If your company has not yet signed a CCLA](broken-reference)
* [If you have not yet been added to your company's approved list](broken-reference)
* [Acknowledge company contribution after you are added to the approved list](broken-reference)
* [If you are additionally asked to sign an ICLA](broken-reference)
...
* **Yes:** Follow the procedure, and click **Proceed** to [coordinate the CCLA signing process](broken-reference).
*   **No:** Provide name and email address of the person who is authorized to be the CLA Manager from your company for this project, and click **Submit Request**. If you do not know who should be the CLA Manager from your company for this project, you should consult with your management or legal department to confirm.
    ...
    **Note:** After the authorized person signs CLA, and adds you to the approved list, you must [complete your company acknowledgement](broken-reference) before you can contribute.
...
* [Yes ](broken-reference)— By clicking **Yes**, you will become the initial CLA Manager after the CCLA is signed.
* [No](broken-reference) — By clicking **No**, you will enter the details of someone else who will become the initial CLA Manager.
...
3\. You will be redirected to the corporate console to [coordinate the CCLA signing process](broken-reference).

{% hint style="warning" %}
**Important:** After the CCLA is signed, you will be the initial CLA Manager, but by default you will not also be an authorized contributor. In order to contribute to the project, you must then [add yourself to the approved list](../../v1-deprecated/cla-manager/approve-contributors.md#add-contributor-s), and [complete the company acknowledgement](broken-reference).
{% endhint %}
...
{% hint style="warning" %}
**Important:** You will receive an email after the CLA Manager adds you to the approved list. After you are added to the approved list, you must [complete your company acknowledgement](broken-reference) before you can contribute to the project.
{% endhint %}
...
Navigate to the Gerrit instance of your project, and re-complete the procedure by following [step 4 through step 10 as described above for Gerrit](broken-reference) to complete company acknowledgement.
...
1. If this is the case for your project, then after your CLA Manager adds you to the approved list, and after you [complete your company acknowledgement](broken-reference), then the following screen appears:\
