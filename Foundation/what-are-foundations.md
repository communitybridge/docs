...
This page shows a list of Foundations and the projects you are a member of. Each Foundation card summarizes information such as total number of members and contributors. The Foundatins can be sorted on the basis of Category ![Category](imgs/category.png) and time of access (Recent/Old/New)![Filter by](imgs/Filter_by.png). You can also search a Foundation using the Search option ![Search](imgs/search_foundation.png). The following table decribes the various entities on the Foundation card:
