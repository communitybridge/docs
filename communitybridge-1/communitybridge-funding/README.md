...
**Note:** You must have an [account](../user-account/create-a-linux-foundation-account.md) or log in to [CommunityBridge Funding](https://funding.communitybridge.org/) website to participate. For details, please see [Login to CommunityBridge](../user-account/docs-login-to-communitybridge/).
