...
2. From the **Source Control** drop-down list, select **GitHub** &gt; **Pull Requests**.
   ...
   A dashboard shows information about pull requests for a project and organization, and information about who submitted the pull request and when. For details, see [Source Control &gt; GitHub &gt; Pull Requests](../viewing-dashboards/pull-request-management/github-pr.md#pull-requests).
