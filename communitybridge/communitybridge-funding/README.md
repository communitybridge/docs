...
**Note:** You must have an [account](../../sso/create-an-account.md) or log in to [CommunityBridge Funding](https://funding.communitybridge.org/) website to participate. For details, please see [Login to CommunityBridge](../../sso/log-in-to-communitybridge/).
