...
3. To view more information:
   ...
   * [Toggle Between Mentorship and Funding](../../funding/dashboard/toggle-between-funding-and-mentorship-for-a-project.md)
4. Participate:
   ...
   * As a company: [Create a Company Profile]() and then [Donate to the Project](../../funding/donate-sponsor/).
...
* **Donate** Opens a [New Donation form](../../funding/donate-sponsor/donate-to-a-project-as-an-individual.md#result-new-donation-form-appears) in CommunityBridge Funding. You can donate as an [individual](../../funding/donate-sponsor/donate-to-a-project-as-an-individual.md) or as an [organization](../../funding/donate-sponsor/donate-as-a-project-sponsor/).
