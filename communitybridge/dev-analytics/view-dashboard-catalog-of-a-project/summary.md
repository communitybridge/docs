...
* **Timezone** shows a pie chart that represents the total number of messages shared by the community members based on their time zones. Base value is GMT, and the numbers from 0 through -9, and so on are considered as hours. For example, number 8 indicates GMT + 8 hrs timezone.
...
* **Timezone** shows a pie chart that represents total number of messages shared by the community members based on their time zones. Base value is GMT, and the numbers from 0 through -9, and so on are considered as hours. For example, number 8 indicates GMT + 8 hrs timezone.
