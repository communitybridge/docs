...
2. From the **Issue Management** drop-down list, select **Jira** &gt; **Backlog**. A dashboard focuses on open issues, their accumulated time, and associated organization. For details, see [Jira &gt; Backlog](../view-project-dashboard/project-management/jira.md#backlog).
