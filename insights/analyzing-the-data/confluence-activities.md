...
2. From the **Documentation** drop-down list, select **Confluence** &gt; **Overview**. The Overview dashboard shows information about Confluence activities. For details, see [Confluence Overview](../collaboration-metrics/documentation/confluence.md#Confluence-Confluence>Overview).
